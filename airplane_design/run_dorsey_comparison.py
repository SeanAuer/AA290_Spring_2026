...
def run_single_point_comparison():
    ...
    # Test fan efficiency variation with Mach number (key Dorsey finding)
    ...
    # Economic range calculation (Dorsey methodology)
    ...
    # 7. Calculate performance differences (key Dorsey metric)
    ...
    # Classify this point in Dorsey design space
...
def create_design_space_visualization():
    """
    Create a visualization showing the Dorsey design space and key regions
    """
    
    print("\nCreating design space visualization...")
    
    # Design space from Dorsey
