...
class OpenRotorStudy:
    ...
    def create_baseline_turbofan(self, passengers, design_range):
        """Create baseline turbofan aircraft similar to Dorsey study"""
    ...
    def _convert_to_aft_open_rotor(self, vehicle):
        ...
        # Create open rotor propeller with Dorsey parameters
    ...
    def _create_open_rotor_propeller(self, mount_type):
        ...
        propeller.cruise.design_angular_velocity = 1100.0 * Units.rpm  # Dorsey used ~1100 RPM
    ...
    def _modify_empennage_for_aft_mount(self, vehicle):
        ...
        # Increase tail sizes (Dorsey found 5% reduction due to end-plating effect)
